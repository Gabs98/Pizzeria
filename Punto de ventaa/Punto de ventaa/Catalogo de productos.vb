...
Public Class Catalogo_de_productos
    ...
    Private Sub Catalogo_de_productos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        DbSql = New SqlConnection(Config.ConectionString)
        DbSql.Open()
    End Sub

    Private Sub frmProductosVenta_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        DbSql.Close()
    End Sub
    ...
    Private Sub btnMateriales_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnMateriales.Click
        If txtNumProducto.Text.ToString().Trim() = "" Then
            ...
            Exit Sub
        End If
        Lista_de_materiales.ManejodeListadeMateriales(txtNumProducto.Text.ToString(), txtNombre.Text.ToString())
