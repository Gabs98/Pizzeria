...
Public Class Venta
    ...
    Private Sub Venta_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        DbSql.Close()
    End Sub
    ...
    Private Sub BuscarProductos()
        ...
        Comm.CommandText = "select * from Productos_Venta where nombre like @nombre"
    ...
    Private Sub btnVentaNueva_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnVentaNueva.Click
        gpbBuscarProducto.Enabled = True
    ...
    Public Function GrabaVenta(ByVal vClienteID As String) As Boolean
        ...
        Try
            ...
            Comm.Parameters.Add("@ventaID", SqlDbType.VarChar, 15).Value = txtId.Text.ToString().Trim()
            Comm.Parameters.Add("@NumEmpleado", SqlDbType.VarChar, 15).Value = ConnSql.ToString()
